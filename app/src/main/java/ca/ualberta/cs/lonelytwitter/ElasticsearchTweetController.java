...
//import static ca.ualberta.cs.lonelytwitter.GetTweetsTask.verifySettings;
...
public class ElasticsearchTweetController {
    ...
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> {
        /* Have to use async task to do networking on Android.*/
        @Override
        protected Void doInBackground(NormalTweet... tweets) {
            /* ... let's you pass in an arbitrary number of arguments*/
            verifySettings();
                ...
                try {
                    ...
                    if(result.isSucceeded()) {
                        tweet.setId(result.getId());
                            ...
                            Log.i("Error", "Elasticsearch was not able to build and send the tweets");
                    }
